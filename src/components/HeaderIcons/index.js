...
export default function HeaderIcons({ name }) {
  const ICONS = {
    ...
    hamburguer: (
      <svg className="h-4 pr-5" viewBox="0 0 18 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
